    ...
    <Layout title="Your Financials" goback={true}>
      <View style={styles.container}>
        ...
        >
          <ImageBackground
            alt=""
            source={require("src/assets/images/icons/financial2.png")}
            resizeMode="cover"
            style={{
              height: Platform.OS === "android" ? 190 : 210,
              borderRadius: 40,
              width: "100%",
            }}
          >
              ...
              <View style={{ width: "100%" }}>
                <View style={styles.flex}>
                  <Image
                    ...
                    resizeMode="contain"
                    style={{
                      width: Platform.OS === "android" ? 115 : 135,
                ...
                <View style={styles.amount}>
                  <Text
                    style={{
                      ...
                      fontSize: Platform.OS === "android" ? 27 : 31,
                  ...
                  {show ? (
                    <Text
                      style={{
                        fontFamily: fontsConstants.Rubik_Medium,
                        fontSize: 28,
                        color: colorsConstants.light.background,
                        marginRight: 10,
                      }}
        ...
        <View
          style={{ marginTop: 20, height: Dimensions.get("window").height }}
        >
          <Tab />
        </View>
      </View>
