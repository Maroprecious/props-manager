                    ...
                    <Success
                        ...
                        feedback={
                            <RNView style={styles.buttons}>
                                <DefaultButton title={`Invite Others `} type='outline' style={styles.button} onPress={() => navigation.navigate('InviteScreen')}>Invite Others</DefaultButton>
                                <DefaultButton title={`Go to Dashboard`}  style={styles.button} onPress={() => {
                                    setVisible(false)
                    ...
                    <RNView style={styles.container}>
                        ...
                        <RNView style={styles.select_Container}>
                            <Select options={options}
                                ...
                                errMsg={errors.status} containerWidth='94%'
                        ...
                        <RNView style={styles.select_Container1}>
                            <RNView style={styles.selectOption}>
                                <Select options={options}
                                    ...
                                    containerWidth='94%' fontFamily={fontsConstants.Lora_Regular}
                                    bgColor='rgba(200, 200, 201, 0.2)'
                                    textstyle={styles.error1}
                                />
                            </RNView>
