...
export default function VerifyWithMobile({
    navigation,
    route
}: RootStackScreenProps<"VerifyWithMobile">) {
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS == 'ios' ? 'padding' : 'height'} style={{ height: '100%' }}>
            ...
            <Layout goback={false} title='Setup 2FA' textstyle={{ marginTop: 80 }}>
                <RNView style={styles.container}>
                    <RNView style={styles.title}>
                        <Text style={[{ color: colorsConstants[theme].titleText }, styles.titleText]}>Please enter the password reset PIN sent to your mobile number </Text>
                        </RNView>
                    <OtpInput
                        value="2501"
                        boxCount={4}
            ...
            {visible &&
                    <Success
                        ...
                        text1='2FA Setup Successful'
                        text2='You have successfully setup 2FA.'
                        text3="With your 2FA setup, you will always be prompted to enter a verification code sent to either your mobile or email ID."
                        feedback={
